...
<div class="sidemenu v-align neomorphism">
    ...
    <div class="menu v-align h-center">
        <a href="painel-administrador.php"><i class='bx bx-scatter-chart'></i> Painel de Dados</a>
        <a href="painel-pedido.php"><i class='bx bx-scatter-chart'></i> Pedidos</a>
        <a href="painel-produtos.php" class="menu-active"><i class='bx bx-scatter-chart'></i> Produtos</a>
