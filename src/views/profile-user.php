...
<?php
    ...
    <div class="container">
        ...
        <div class="container-geral-perfil">
            ...
            <div class="container-perfil">
                ...
                <div class="title-perfil">
                    <i class='bx bxs-user-circle' style='color:#05d0ff; margin-left: 1rem;'></i>
                ...
                <div class="info-perfil-apelido">
                    <i class='bx bxs-ghost' style="color:orange;"></i>
                ...
                <div class="info-perfil-email">
                    <i class='bx bxl-gmail' style="color:red;"></i>

                    <p>neyjuniorsantos@gmail.com</p>
        ...
        <div class="endereco-user">
                ...
                <div class="two">
                    <label id="title">Endereço padrão:</label>
                    <label id="nome">Neymar da Silva Santos Júnior</label>
                    <label for="">Rua Nossa Senhora do Roário 3164</label>
                    <label for="">Itacoatiara, AM 69104570</label>
                    <label for="">Brasil</label>
                    <label for="">Telefone:97981405568</label>
                    <a href="">Adicionar instruções de entrega</a>
                ...
                <div class="tree">
                    <label id="nome">Lidia Bezerra da Silva</label>
                    <label>Apartamento 02 Nova Floresta</label>
                    <label>Porto Velho, RO 76806710</label>
                    <label>Brasil</label>
                    <label>Telefone:97991549044</label>
                    <a href="">Adicionar instruções de entrega</a>
                    
                    <div class="btn">
                        <a href="">Alterar</a>
                        <a href="">Excluir</a>
                        <a href="">Definir Padrão</a>
                    </div>
                </div>
        </div>
